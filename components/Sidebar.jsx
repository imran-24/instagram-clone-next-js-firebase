  ...
  return (
        ...
        <div className='h-screen xl:w-64  w-24 bg-white py-8 px-6 hidden md:flex flex-col  justify-between sticky top-0 left-0  border-r '>
            ...
            <div className='relative h-10 xl:hidden w-8 mx-auto'>
                <Image src='https://cdn-icons-png.flaticon.com/512/87/87390.png' layout='fill' objectFit='contain' />
            </div>
            ...
            <div className=' flex flex-col gap-10 '>
                ...
                <div onClick={() => signOut({callbackUrl: '/auth/signin'})}  className='flex items-center gap-4 lg:mx-0 mx-auto cursor-pointer'>
